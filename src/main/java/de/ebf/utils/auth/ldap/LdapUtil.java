...
public class LdapUtil {
   ...
   public static final String[] ATTR_ALL = new String[]{ATTR_CN, ATTR_FIRST_NAME, ATTR_LAST_NAME, ATTR_UID, ATTR_MAIL, ATTR_TELEPHONE_NUMBER, ATTR_ENTRYUUID, ATTR_MEMBERS, ATTR_MEMBER_OF};
   public static final String OBJECTCLASS_USER = "inetOrgPerson";
   public static final String OBJECTCLASS_GROUP = "groupOfUniqueNames";
   public static final String OBJECT_CLASS_OU = "organizationalUnit";
   public static final String OBJECT_CLASS_ORGANIZATION = "domain";
   public static final String ATTR_DN = "entryDN";

...
public class LdapOrganizationManager implements OrganizationManager {
    ...
    public String addOrganization(String name) throws LdapException {
        ...
        try {
            ...
            connection = LdapUtil.getConnection(LdapDefaultConfig.getInstance());
   ...
   public List<LdapOrganization> getLdapOrganizations(String baseDN) throws LdapException {
      ...
      try {
         ...
         SearchResult searchResults = connection.search(LdapDefaultConfig.getInstance().getBaseDN(), SearchScope.ONE, (LdapUtil.ATTR_OBJECTCLASS + "=" + LdapUtil.OBJECT_CLASS_OU), LdapUtil.ATTR_DN);
   ...
   private DN getDN(String name) throws LDAPException {
      return new DN("ou=" + name + "," + LdapDefaultConfig.getInstance().getBaseDN());
   }
}
